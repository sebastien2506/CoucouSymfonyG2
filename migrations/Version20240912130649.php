 ...
 */
final class Version20240912130649 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section ADD section_titel VARCHAR(160) NOT NULL, ADD section_description VARCHAR(600) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE section DROP section_titel, DROP section_description');
